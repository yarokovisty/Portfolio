...
class ForecastRepositoryImpl @Inject constructor(
    ...
    override suspend fun getCurrentWeather(lon: Double, lat: Double): CurrentWeatherItem {
        val currentWeatherDTO = remoteForecastDataSource.getCurrentWeather(lon, lat)
        return mapper.mapCurrentWeatherDTOtoCurrentWeatherItem(currentWeatherDTO)
    }
